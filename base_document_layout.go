...
type BaseDocumentLayout struct {
	...
	L10NDin5008DeliveryDate *Time      `xmlrpc:"l10n_din5008_delivery_date,omitempty"`
	L10NDin5008DueDate      *Time      `xmlrpc:"l10n_din5008_due_date,omitempty"`
	L10NDin5008InvoiceDate  *Time      `xmlrpc:"l10n_din5008_invoice_date,omitempty"`
